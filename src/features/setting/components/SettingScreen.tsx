...
export default function SettingScreen() {
   ...
   const ALL_MENUS_AND_ITEMS: MenuAndItemsT[] = useMemo(() => {
      return [
         {
            id: 1,
            title: t('setting:menu.general.title'),
            items: [
               {
                  id: 1,
                  label: t('setting:menu.general.item_language'),
                  action: () => handleOpenLanguageSheet(),
                  defaultValue: t(`common:language.${currentLanguage as LanguageCodeSupportedT}`),
               },
               {
                  id: 2,
                  label: t('setting:menu.general.item_theme'),
   ...
   return (
      <Scaffold typeOfScreen="tab" titleTabScreen={t('common:tab_navigation.label.setting')}>
